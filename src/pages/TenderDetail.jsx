      ...
      <div className="px-4 mt-4 space-y-4">
        ...
        {tender.description && (
          <div className="bg-card border border-border rounded-2xl p-4">
            <h2 className="font-heading text-sm font-bold uppercase tracking-wide mb-2">Scope</h2>
        ...
        {tender.document_url && (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold">Tender Document</p>
              <p className="text-xs text-muted-foreground">Download full specification (PDF)</p>
            </div>
