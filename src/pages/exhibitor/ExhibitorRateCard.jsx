    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-6 pb-32">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="text-muted-foreground text-xs mt-1">All prices shown are in USD and exclude VAT.</p>
        </div>
            ...
            {checkout === 'eft-submitted' ? (
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <div>
                    <p className="font-heading text-lg font-bold leading-tight">${cartTotal}</p>
                    <p className="text-[10px] text-muted-foreground leading-tight">excl. VAT</p>
                  </div>
                  <button
