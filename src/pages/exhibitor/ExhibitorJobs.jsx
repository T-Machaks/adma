  ...
  if (!standTierAtLeast(myBooth.tier, 'Enhanced')) {
    return (
      <div className="max-w-2xl mx-auto px-6 py-16 text-center">
        ...
        <h1 className="font-heading text-xl font-bold mb-2">Job postings are an Enhanced Stand feature</h1>
        <p className="text-muted-foreground text-sm mb-6 max-w-md mx-auto">
          You're currently on a <strong>Basic Stand</strong> ({myBooth.tier} tier). Upgrade to Silver or above to post job openings to attendees.
        </p>
        <a
