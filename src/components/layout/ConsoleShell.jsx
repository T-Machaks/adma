...
const consoleNav = [
  ...
  { path: '/console/rate-card',              label: 'Rate Card',              icon: DollarSign,    roles: ['organizer', 'superadmin'] },
  { path: '/console/payments',               label: 'Payments',               icon: CreditCard,    roles: ['organizer', 'superadmin'] },
